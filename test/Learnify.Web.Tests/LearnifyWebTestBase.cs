...
{
    public abstract class LearnifyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LearnifyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LearnifyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LearnifyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LearnifyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LearnifyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LearnifyDbContext, Task<T>> func)
        {
            T result;
